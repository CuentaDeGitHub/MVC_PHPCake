 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $asentamiento
 */
?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $this->Number->format($asentamiento->id) ?></td>
                    <td><?= h($asentamiento->descripcion) ?></td>
                    <td><?= h($asentamiento->codigoPostal) ?></td>
                    <td><?= $this->Number->format($asentamiento->idTipoDeAsentamiento) ?></td>
                    <td><?= $this->Number->format($asentamiento->idMunicipio) ?></td>
                    <td><?= $asentamiento->idZona === null ? '' : $this->Number->format($asentamiento->idZona) ?></td>
                    <td><?= h($asentamiento->estatus) ?></td>
                    <td><?= $asentamiento->idUsuarioCrea === null ? '' : $this->Number->format($asentamiento->idUsuarioCrea) ?></td>
