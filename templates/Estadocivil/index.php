 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $estadocivil
 */
?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= h($estadocivil->descripcion) ?></td>
                    <td><?= h($estadocivil->estatus) ?></td>
                    <td><?= $estadocivil->idUsuarioCrea === null ? '' : $this->Number->format($estadocivil->idUsuarioCrea) ?></td>
