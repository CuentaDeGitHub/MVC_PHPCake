...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $tipodeproveedor->idTipoDeProveedor],
                ['confirm' => __('Are you sure you want to delete # {0}?', $tipodeproveedor->idTipoDeProveedor), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="tipodeproveedor form content">
            ...
            <fieldset>
                <legend><?= __('Edit Tipodeproveedor') ?></legend>
                <?php
