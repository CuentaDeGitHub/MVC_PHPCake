 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $puesto
 */
?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $this->Number->format($puesto->salario) ?></td>
                    <td><?= h($puesto->estatus) ?></td>
                    <td><?= $puesto->idUsuarioCrea === null ? '' : $this->Number->format($puesto->idUsuarioCrea) ?></td>
