...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $nacionalidad->idNacionalidad],
                ['confirm' => __('Are you sure you want to delete # {0}?', $nacionalidad->idNacionalidad), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="nacionalidad form content">
            ...
            <fieldset>
                <legend><?= __('Edit Nacionalidad') ?></legend>
                <?php
