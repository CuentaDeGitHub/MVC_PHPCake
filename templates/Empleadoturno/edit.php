...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $empleadoturno->idEmpleadoTurno],
                ['confirm' => __('Are you sure you want to delete # {0}?', $empleadoturno->idEmpleadoTurno), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="empleadoturno form content">
            ...
            <fieldset>
                <legend><?= __('Edit Empleadoturno') ?></legend>
                <?php
